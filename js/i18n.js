...
(function () {
  ...
  const DICT = {
    sq: {
      ...
      projects: { eyebrow: 'Portofoli', title: 'Projekte', note: 'Një përzgjedhje projektesh — furnizim, zgjidhje dhe mbështetje në terren.', viewAll: 'Shiko të gjitha projektet' },
      project: { kategoria: 'Kategoria', lokacioni: 'Lokacioni', viti: 'Viti', materialet: 'Materialet e përdorura', galeria: 'Galeria e projektit' },
      ...
      gallery: { eyebrow: 'Galeria', title: 'Galeri', note: 'Momente nga projektet, terreni, materialet dhe produktet.', f_all: 'Të gjitha', f_projekte: 'Projekte', f_terren: 'Terren', f_materiale: 'Materiale', f_produkte: 'Produkte' },
    ...
    fr: {
      ...
      projects: { eyebrow: 'Portfolio', title: 'Projets', note: 'Une sélection de projets — fourniture, solutions et accompagnement sur chantier.', viewAll: 'Voir tous les projets' },
      project: { kategoria: 'Catégorie', lokacioni: 'Emplacement', viti: 'Année', materialet: 'Matériaux utilisés', galeria: 'Galerie du projet' },
      ...
      gallery: { eyebrow: 'Galerie', title: 'Galerie', note: 'Moments des projets, du chantier, des matériaux et des produits.', f_all: 'Toutes', f_projekte: 'Projets', f_terren: 'Chantier', f_materiale: 'Matériaux', f_produkte: 'Produits' },
    ...
    de: {
      ...
      projects: { eyebrow: 'Portfolio', title: 'Projekte', note: 'Eine Auswahl von Projekten — Lieferung, Lösungen und Unterstützung vor Ort.', viewAll: 'Alle Projekte ansehen' },
      project: { kategoria: 'Kategorie', lokacioni: 'Standort', viti: 'Jahr', materialet: 'Verwendete Materialien', galeria: 'Projektgalerie' },
      ...
      gallery: { eyebrow: 'Galerie', title: 'Galerie', note: 'Momente aus Projekten, vom Einsatzort, von Materialien und Produkten.', f_all: 'Alle', f_projekte: 'Projekte', f_terren: 'Vor Ort', f_materiale: 'Materialien', f_produkte: 'Produkte' },
