...
(function () {
  ...
  function projectCard(p) {
    ...
    return '<button type="button" class="project-card" data-project-id="' + esc(p.id) + '" aria-label="' + esc(L(p.title)) + '">' +
      '<div class="project-card__media">' + img(p.image, L(p.title), p.ratio) + '</div>' +
      ...
      (meta ? '<div class="project-card__meta">' + esc(meta) + '</div>' : '') +
