...
(function () {
  ...
  var PROJECTS = [
    { id: 'qtx', featured: true, image: 'assets/projects/qtx-05.jpg', ratio: 'wide', location: 'Xërxe, Kosovë', year: '',
      ...
      videos: ['assets/video/qtx-1.mp4', 'assets/video/qtx-2.mp4', 'assets/video/qtx-3.mp4'],
      gallery: ['assets/projects/qtx-06.jpg', 'assets/projects/qtx-07.jpg', 'assets/projects/qtx-13.jpg', 'assets/projects/qtx-14.jpg', 'assets/projects/qtx-01.jpg', 'assets/projects/qtx-03.jpg', 'assets/projects/qtx-10.jpg', 'assets/projects/qtx-11.jpg', 'assets/projects/qtx-12.jpg', 'assets/projects/qtx-15.jpg', 'assets/projects/qtx-08.jpg', 'assets/projects/qtx-09.jpg', 'assets/projects/qtx-02.jpg', 'assets/projects/qtx-16.jpg', 'assets/projects/qtx-04.jpg'] },
  ...
  var GALLERY = [
    ...
    { image: 'assets/gallery/gallery-05.jpg', ratio: 'wide', cat: 'terren', caption: { sq: 'Baza & furnizimi', fr: 'Le dépôt & la fourniture', de: 'Standort & Versorgung' } },
    { image: 'assets/gallery/gallery-06.jpg', ratio: 'portrait', cat: 'terren', caption: { sq: 'Dërgesa te objekti', fr: 'Livraisons au chantier', de: 'Lieferungen zum Objekt' } },
    { image: 'assets/gallery/gallery-07.jpg', ratio: 'portrait', cat: 'terren', caption: { sq: 'Transport & dërgesë', fr: 'Transport & livraison', de: 'Transport & Lieferung' } },
    ...
    { image: 'assets/gallery/gallery-12.jpg', ratio: 'portrait', cat: 'projekte', caption: { sq: 'Armaturë në terren', fr: 'Armatures sur chantier', de: 'Bewehrung vor Ort' } },
    ...
    { image: 'assets/projects/qtx-06.jpg', ratio: 'portrait', cat: 'projekte', caption: { sq: 'Montim i shenjës QTX Mall', fr: 'Installation de l\'enseigne QTX Mall', de: 'Montage des QTX-Mall-Schilds' } },
    { image: 'assets/projects/qtx-13.jpg', ratio: 'portrait', cat: 'projekte', caption: { sq: 'Totem reklamues', fr: 'Totem publicitaire', de: 'Werbetotem' } },
    { image: 'assets/projects/qtx-01.jpg', ratio: 'portrait', cat: 'terren', caption: { sq: 'Montim strukture çeliku', fr: 'Montage de structure acier', de: 'Stahlstruktur-Montage' } }
  ];
  ...
  var BRAND_GROUPS = [
    { key: 'elektrik', icon: 'M13 2 4 14h7l-1 8 9-12h-7z',
      ...
      brands: [{ name: 'GEWISS', featured: true }, { name: 'TM', featured: true }, { name: 'Schneider Electric' }, { name: 'ABB' }, { name: 'Legrand' }, { name: 'BTicino' }, { name: 'Hager' }, { name: 'Vimar' }] },
    { key: 'cimento', icon: 'M3 17l7-7 4 4 7-7M3 21h18',
      ...
      brands: [{ name: 'Sika' }, { name: 'Mapei' }, { name: 'Knauf' }, { name: 'Baumit' }, { name: 'Weber' }, { name: 'Ceresit' }] },
    { key: 'izolim', icon: 'M12 3l9 5-9 5-9-5 9-5zM3 12l9 5 9-5M3 16l9 5 9-5',
      ...
      brands: [{ name: 'Rockwool' }, { name: 'Knauf Insulation' }, { name: 'Isover' }, { name: 'Ursa' }, { name: 'Austrotherm' }] },
    { key: 'sanitari', icon: 'M6 12V5a2 2 0 012-2h1M4 12h16v3a5 5 0 01-5 5H9a5 5 0 01-5-5z',
      ...
      brands: [{ name: 'Geberit' }, { name: 'Grohe' }, { name: 'Valsir' }, { name: 'Viega' }, { name: 'Wavin' }, { name: 'Rehau' }] },
    { key: 'ngjyra', icon: 'M4 20s1-4 4-4 4 3 8-1M14 14l6-6a2 2 0 00-3-3l-6 6',
      ...
      brands: [{ name: 'Caparol' }, { name: 'Jotun' }, { name: 'San Marco' }, { name: 'Sikkens' }] }
  ];
